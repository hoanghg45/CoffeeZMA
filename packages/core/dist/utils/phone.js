...
exports.getPhoneDisplayText = getPhoneDisplayText;
...
function isValidVietnamesePhone(phoneNumber) {
    if (!phoneNumber) {
        return false;
    }
    const digits = phoneNumber.replace(/\D/g, "");
...
function getPhoneDisplayText(phoneNumber, fallback = "Chưa có số điện thoại") {
    if (phoneNumber == null) {
        return fallback;
    }
